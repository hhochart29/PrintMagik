        ...
        <li v-for="product in products" v-if="!product.isHidden" :key="product.id">
          ...
          <div class="collapsible-body row">
            <div class="col m6 s12">
              <div class="image" style="height:200px; background-position: center center; -webkit-background-size: cover;background-size: cover;" v-bind:style='{ backgroundImage: "url(" + product.image + ")" }'></div>
            </div>
            <div class="col m6 s12">
